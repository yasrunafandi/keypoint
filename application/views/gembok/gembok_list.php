...
<html>
    ...
    <br><br>
        <h2 style="margin-top:0px"><a href="<?php echo base_url();?>home"> Gembok List</a></h2>
        <div class="row" style="margin-left: 5px; margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('gembok/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('gembok/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('gembok'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('gembok/read/'.$gembok->Id_Gembok),'Read'); 
				echo ' | '; 
				echo anchor(site_url('gembok/update/'.$gembok->Id_Gembok),'Update'); 
				echo ' | '; 
				echo anchor(site_url('gembok/delete/'.$gembok->Id_Gembok),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('gembok/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('gembok/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
