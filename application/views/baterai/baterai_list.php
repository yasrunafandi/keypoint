...
<html>
    ...
    <br><br>
        <h2 style="margin-top:0px; margin-left: 5px"><a href="<?php echo base_url();?>home"> Baterai List</a></h2>
        <div class="row" style="margin-bottom: 10px; margin-left: 5px">
            <div class="col-md-4">
                <?php echo anchor(site_url('baterai/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('baterai/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('baterai'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <table class="table table-bordered" style="margin-bottom: 10px; margin-left: 5px; margin-right: 5px" >
            <tr>
                <th>No</th>
		<th>Merk</th>
		<th>Kapasitas</th>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('baterai/read/'.$baterai->Id_Baterai),'Read'); 
				echo ' | '; 
				echo anchor(site_url('baterai/update/'.$baterai->Id_Baterai),'Update'); 
				echo ' | '; 
				echo anchor(site_url('baterai/delete/'.$baterai->Id_Baterai),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('baterai/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('baterai/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
