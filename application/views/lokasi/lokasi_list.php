...
<html>
    ...
    <br><br>
        <h2 style="margin-top:0px"><a href="<?php echo base_url();?>home"> Lokasi List</a></h2>
        <div class="row" style="margin-left: 5px; margin-bottom: 10px">
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('lokasi/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('lokasi'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td><?php echo $lokasi->Area ?></td>
			<td><?php echo $lokasi->Rayon ?></td>
			<td><?php echo $lokasi->Gardu_Induk ?></td>
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('lokasi/read/'.$lokasi->Id_Lokasi),'Read'); 
				echo ' | '; 
				echo anchor(site_url('lokasi/update/'.$lokasi->Id_Lokasi),'Update'); 
				echo ' | '; 
				echo anchor(site_url('lokasi/delete/'.$lokasi->Id_Lokasi),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('lokasi/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('lokasi/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
