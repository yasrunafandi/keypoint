...
<html>
    ...
    <br><br>
        <h2 style="margin-top:0px"><a href="<?php echo base_url();?>home"> Modem List</a></h2>
        <div class="row" style="margin-left: 5px; margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('modem/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('modem/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('modem'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('modem/read/'.$modem->Id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('modem/update/'.$modem->Id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('modem/delete/'.$modem->Id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('modem/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('modem/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
