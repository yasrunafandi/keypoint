...
<html>
    ...
    <br><br>
        <h2 style="margin-top:0px"><a href="<?php echo base_url();?>home"> Gatway List</a></h2>
        <div class="row" style="margin-bottom: 10px; margin-left: 5px">
            <div class="col-md-4">
                <?php echo anchor(site_url('gatway/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('gatway/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('gatway'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
        ...
        <table class="table table-bordered" style="margin-left: 5px; margin-bottom: 10px " >
            <tr>
                <th>No</th>
		<th>Nama Gatway</th>
		<th>IP Gatway</th>
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('gatway/read/'.$gatway->Id_Gatway),'Read'); 
				echo ' | '; 
				echo anchor(site_url('gatway/update/'.$gatway->Id_Gatway),'Update'); 
				echo ' | '; 
				echo anchor(site_url('gatway/delete/'.$gatway->Id_Gatway),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('gatway/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('gatway/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
