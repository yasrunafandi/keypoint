...
<html>
    ...
    <br><br>
        <h2 style="margin-top:0px"><a href="<?php echo base_url();?>home"> Switch_gear List</a></h2>
        <div class="row" style="margin-left: 5px ; margin-bottom: 10px">
            <div class="col-md-4">
                <?php echo anchor(site_url('switch_gear/create'),'Create', 'class="btn btn-primary"'); ?>
            </div>
            ...
            <div class="col-md-3 text-right">
                <form action="<?php echo site_url('switch_gear/index'); ?>" class="form-inline" method="get">
                    <div class="input-group">
                        ...
                        <span class="input-group-btn">
                            <?php 
                                ...
                                {
                                    ?>
                                    <a href="<?php echo site_url('switch_gear'); ?>" class="btn btn-default">Reset</a>
                                    <?php
                                }
                            ?>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('switch_gear/read/'.$switch_gear->Id_Status_Switch_Gear),'Read'); 
				echo ' | '; 
				echo anchor(site_url('switch_gear/update/'.$switch_gear->Id_Status_Switch_Gear),'Update'); 
				echo ' | '; 
				echo anchor(site_url('switch_gear/delete/'.$switch_gear->Id_Status_Switch_Gear),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
		...
		<?php echo anchor(site_url('switch_gear/excel'), 'Excel', 'class="btn btn-primary"'); ?>
		<?php echo anchor(site_url('switch_gear/word'), 'Word', 'class="btn btn-primary"'); ?>
	    </div>
